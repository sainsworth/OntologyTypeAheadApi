...
namespace OntologyTypeAheadApi.Tests.ServiceTests
{
    ...
    public class DatastoreServiceTests
    {
        ...
        [TestMethod]
        public async void Mock_DatastoreContext_All()
        {
        ...
        [TestMethod]
        public async void Mock_DatastoreContext_Equals()
        {
        ...
        [TestMethod]
        public async void Mock_DatastoreContext_Equals_CaseSensitive()
        {
        ...
        [TestMethod]
        public async void Mock_DatastoreContext_StartsWith()
        {
        ...
        [TestMethod]
        public async void Mock_DatastoreContext_StartsWith_CaseSensitive()
        {
        ...
        [TestMethod]
        public async void Mock_DatastoreContext_Contains()
        {
